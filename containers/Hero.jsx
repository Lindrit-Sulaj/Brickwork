...
export default function Hero() {
  return (
    <section className='hero-bg py-24 md:py-32 lg:py-44'>
      <div className='max-w-screen-lg mx-auto px-6 md:px-8'>
        ...
        <p className='mt-5 text-neutral-200 md:text-neutral-300 md:text-lg max-w-3xl'>Unleashing the beauty of construction, we create timeless structures that stand the test of time. With unrivaled expertise and meticulous craftsmanship, we turn visions into reality, one brick at a time.</p>
